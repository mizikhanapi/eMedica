...
<%@page import="smsengine.SMSEnginee"%>
...
//            SMSEnginee send = new SMSEnginee();
//            send.SendMessage("0132231446", "Hai");


            %><script language='javascript'>
                $(document).ready(function() {
                    var url = "http://10.73.32.200/Testing/SendEmail2.jsp";
                    $.post(url, {
                        email: "<%=email%>",
                        subject: "e-Appointment Auto Reminder",
