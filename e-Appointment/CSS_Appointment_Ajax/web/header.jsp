...
<head>
        ...
        <script type="text/javascript" src="<%=Config.getBase_url(request) %>js/jquery.ptTimeSelect.js"></script> 

   <script src="<%=Config.getBase_url(request) %>js/24hourTime.js"></script>
