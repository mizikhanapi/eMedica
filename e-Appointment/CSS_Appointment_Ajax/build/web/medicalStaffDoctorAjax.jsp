...
%>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10"> 
                                                ...
                                                <input name="doctorApp" value="<%= doctor%>" type="text"  class="form-control" readonly>
                                                <input name="doctorApp" value="<%= username%>" id="doctorApp" type="hidden"  class="form-control" readonly>
                                            </div>
                                        </div>
                                        <div class="form-group">
...
//                                
                            ...
                            <div class='row' style="padding-bottom: 2%; padding-top: 2%; padding-left: 2%; background-color: #d9d9d9; margin-bottom: 4%">
                                ...
                                <div class="col-md-3 col-sm-12 col-xs-12">
                                    ...
                                    <button class="btn btn-info" id="viewDoctorAppointment">View Your Appointment</button>
