            ...
            <div class="row myform">
               <div class="col-md-8 col-md-offset-2">
                  ...
                  <p style="color: red"> *** Please make sure that you have check the availability and also view the holiday before make an appointment</p>
                    <p>Patient Details :</p>
                    <form class="form-horizontal" role="form" method="post" action="medicalStaffNurseCheckAppointment.jsp">
                        <%    
                ...
                <div class='row' style="padding-bottom: 2%; padding-top: 2%; padding-left: 2%; background-color: #d9d9d9; margin-bottom: 4%">
                    ...
                    <form method="post" name="myform" role="form" action="medicalStaffNurseSelectDate.jsp">
                        <div class="form-inline" >
                            <div class="form-group">
                               <!--<label>PMI No :</label>-->
                               <input type="date" name="searchAppointmentDate" class="form-control" placeholder="Search Appointment Date" required/>
                            </div>
                            <div class="form-group">
                                <button class="btn btn-xs btn-success">Search</button>
                            </div>
                    ...
                    <form method="post" name="myform" role="form" action="medicalStaffNurseSelectDoctor.jsp">
                        <div class="form-inline" >
                            <div class="form-group">
                               <!--<label>PMI No :</label>-->
                               <input type="text" name="searchAppointmentDoctor" class="form-control" placeholder="Search Doctor Name" required/>
                            </div>
                            <div class="form-group">
                                <button class="btn btn-xs btn-success">Search</button>
                            </div>
...
//                                    String endLeave = DATE_FORMAT.format(endLeaveDate);
                                    ...
                                    <%
                                                    ...
                                                    <script>
                                                        function myFunction(e27,e48,e32)
                                                        {
                                                            ...
                                                            if (result != null)
                                                            {
                                                                if(result != "")
                                                                {    
                                                                    window.location = 'cancelAppointment.jsp?e27='+e27+'&e48='+e48+'&e32='+e32+'&status=inactiev&canceled_by=<%=username%>&canceledReason='+result;
                                                                }
                                                                else
                                                                {
                                                                    return false;
                                        ...
                                        else if((covertedAppDate.after(currentDate) || appointmentDate.contentEquals(todayDate)) && dataAppointment.get(i).get(9).equals("inactive"))
                                        {%>
