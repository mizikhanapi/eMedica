                ...
                function a() 
                {
                    ...
                    try
                    {
                        ...
                        if (error != null) 
                        {
                            %>
                            alert('<%=error %>');
                            location.href = 'medicalStaffDoctor.jsp';
                            <%
                        }
                    } 
                    catch (Exception e) 
            ...
            <div id="holiday" class="tab-pane fade">
                ...
                <div class="dropdown"  style="padding-bottom: 2%">
                    ...
                    <ul class="dropdown-menu" role="menu" aria-labelledby="menu1" >
                      <li role="presentation"><a role="menuitem" tabindex="-1" href="medicalStaffDoctor.jsp">National And State</a></li>
                      <li role="presentation"><a role="menuitem" tabindex="-1" href="medicalStaffDoctorViewNational.jsp">National</a></li>
                      <li role="presentation"><a role="menuitem" tabindex="-1" href="medicalStaffDoctorViewJohor.jsp">Johor</a></li>
                      <li role="presentation"><a role="menuitem" tabindex="-1" href="medicalStaffDoctorViewKedah.jsp">Kedah</a></li>
                      <li role="presentation"><a role="menuitem" tabindex="-1" href="medicalStaffDoctorViewKelantan.jsp">Kelantan</a></li>
                      <li role="presentation"><a role="menuitem" tabindex="-1" href="medicalStaffDoctorViewMelaka.jsp">Melaka</a></li>
                      <li role="presentation"><a role="menuitem" tabindex="-1" href="medicalStaffDoctorViewNegeri9.jsp">Negeri Sembilan</a></li>
                      <li role="presentation"><a role="menuitem" tabindex="-1" href="medicalStaffDoctorViewPahang.jsp">Pahang</a></li>
                      <li role="presentation"><a role="menuitem" tabindex="-1" href="medicalStaffDoctorViewPerak.jsp">Perak</a></li>
                      <li role="presentation"><a role="menuitem" tabindex="-1" href="medicalStaffDoctorViewPerlis.jsp">Perlis</a></li>
                      <li role="presentation"><a role="menuitem" tabindex="-1" href="medicalStaffDoctorViewPenang.jsp">Pulau Pinang</a></li>
                      <li role="presentation"><a role="menuitem" tabindex="-1" href="medicalStaffDoctorViewSabah.jsp">Sabah</a></li>
                      <li role="presentation"><a role="menuitem" tabindex="-1" href="medicalStaffDoctorViewSarawak.jsp">Sarawak</a></li>
                      <li role="presentation"><a role="menuitem" tabindex="-1" href="medicalStaffDoctorViewSelangor.jsp">Selangor</a></li>
                      <li role="presentation"><a role="menuitem" tabindex="-1" href="medicalStaffDoctorViewTerengganu.jsp">Terengganu</a></li>
                      <li role="presentation"><a role="menuitem" tabindex="-1" href="medicalStaffDoctorViewKL.jsp">Wilayah Persekutuan Kuala Lumpur</a></li>
                      <li role="presentation"><a role="menuitem" tabindex="-1" href="medicalStaffDoctorViewPutrajaya.jsp">Wilayah Persekutuan Putrajaya</a></li>
                      <li role="presentation"><a role="menuitem" tabindex="-1" href="medicalStaffDoctorViewLabuan.jsp">Wilayah Persekutuan Labuan</a></li>
                    </ul>
                  </div>
...
//                                 %>
          ...
          <div id="leave" class="tab-pane fade">
                ...
                <form class="form-horizontal" role="form" method="post" action="addLeaveDoctor.jsp"> 
...
//                                    out.print(isSelect);
                            ...
                            <div class='row' style="padding-bottom: 2%; padding-top: 2%; padding-left: 2%; background-color: #d9d9d9; margin-bottom: 4%">
                                <div class="col-md-6 col-sm-12 col-xs-12">
                                    <form method="post" name="myform" role="form" action="medicalStaffDoctorAppointmentViewDateAvailability.jsp">
...
<!--                                            <div class="form-group">
                        ...
                        <!--</div>-->
                                    ...
                                    <form method="post" name="myform" role="form" action="medicalStaffDoctor.jsp">
            ...
            <div class="row myform">
               <div class="col-md-8 col-md-offset-2">
                  ...
                  <p style="color: red"> *** Please make sure that you have check the availability and also view the holiday before make an appointment</p>
                    <p>Patient Details :</p>
                    <form class="form-horizontal" role="form" method="post" action="medicalStaffDoctorCheckAppointment.jsp">
                        <%    
...
//                            out.print(sql);
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10"> 
                            <%  
                                String sqlDoc = "SELECT USER_NAME "
                                        + "FROM adm_user "
                                        + "WHERE USER_ID = '"+username+"'";
                                ArrayList<ArrayList<String>> dataDoctor = Conn.getData(sqlDoc);
                                
                                String doctor = dataDoctor.get(0).get(0);  %>
                         
                                <input name="appDoc" value="<%= doctor %>" type="text"  class="form-control" readonly>
                        </div>
                    </div>
                    <div class="form-group">
            ...
            <div id="viewAppointment" class="tab-pane fade">
                ...
                <div class='row' style="padding-bottom: 2%; padding-top: 2%; padding-left: 2%; background-color: #d9d9d9; margin-bottom: 4%">
                    ...
                    <form method="post" name="myform" role="form" action="medicalStaffDoctorSelectDate.jsp">
                        <div class="form-inline" >
                            <div class="form-group">
                               <!--<label>PMI No :</label>-->
                               <input type="date" name="searchAppointmentDate" id="datepicker" class="form-control" placeholder="Search Appointment Date" required/>
                            </div>
                            <div class="form-group">
                                <button class="btn btn-xs btn-success">Search</button>
                            </div>
                    ...
                    <div class="col-md-3 col-sm-12 col-xs-12">
                    <form method="post" name="myform" role="form" action="medicalStaffDoctorSelectPatient.jsp">
                        <div class="form-inline" >
                            <div class="form-group">
                               <!--<label>PMI No :</label>-->
                               <input type="text" name="searchAppointmentPatient" class="form-control" placeholder="Search Patient Name" required/>
                            </div>
                            <div class="form-group">
                                <button class="btn btn-xs btn-success">Search</button>
                            </div>
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-6" style="padding-left: 5%">
                    <form method="post" name="myform" role="form" action="medicalStaffDoctor.jsp">
                        <button class="btn btn-info">View Your Appointment</button>
                    </form>
                    </div>
                    <div class="col-md-3 col-sm-6 col-xs-6">
                    <form method="post" name="myform" role="form" action="medicalStaffDoctorSelectAll.jsp">
...
//                                out.print(appDateFromOtherForm);
                                ...
                                String sqlAppointmentDate = "SELECT lookSub.appointment_date, lookSub.start_time, lookSub.pmi_no, lookSub.patient_name, "
                                                ...
                                                + "LCASE(au.USER_NAME) AS USER_NAME, pa.discipline, pa.subdiscipline, pa.appointment_type, pb.ID_NO, pa.status, pa.canceled_reason "
                                                + "FROM pms_appointment pa, pms_patient_biodata pb, adm_user au "
                                                + "WHERE pa.pmi_no = pb.PMI_NO AND pa.userid = au.USER_ID AND pa.userid = '"+username+"' AND DATE(pa.appointment_date) = '"+appDateFromOtherForm+"' "
                                                + "ORDER BY pa.appointment_date DESC, start_time ASC) lookDis "
                                                + "WHERE lookDis.discipline=ld.Detail_Ref_code "
                                                + "AND ld.Master_Ref_code = '0072') lookSub "
                                                + "WHERE lds.Master_Ref_code = '0071' "
...
//                                out.print(sqlAppointmentDate);
                           ...
                           <%
                                        ...
                                        { %>
                                            ...
                                            <td class="incoming_date_area"><center><%=appointmentDateFromOtherForm%></center></td>
                                        ...
                                        {%>
                                            ...
                                            <td><center><%=appointmentDateFromOtherForm%></center></td>
                                            ...
                                            <td>
                                                <center>
                                                    <button disabled="disabled" class="btn btn-xs btn-primary" onClick="location.href='medicalStaffDoctorCancelAppointment.jsp?e27=<%=dataAppointment.get(i).get(2)%>&e48=<%=hfcCD%>&e32=<%=searchAppointmentDate%>'">Cancel</button>
                                                </center>
                                            </td>
                                            <td><center><%=dataAppointmentDate.get(i).get(10)%></center></td>
                                        <%
                                        }
                                        else
                                        {%>
