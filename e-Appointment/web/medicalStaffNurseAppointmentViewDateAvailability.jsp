<%-- 
    Document   : medicalStaffNurseAppointmentViewDateAvailability
    Created on : Jul 31, 2016, 2:13:54 PM
    Author     : user
--%>
            ...
            <div id="doctorDirectory" class="tab-pane fade">
                ...
                <div class='row' style="padding-bottom: 2%; padding-top: 2%; padding-left: 2%; background-color: #d9d9d9; margin-bottom: 4%">
                    <div class="col-md-6 col-sm-12 col-xs-12">
                        <form method="post" name="myform" role="form" action="medicalStaffNurseViewDateAvailability.jsp">
