...
//    out.print(username);
    ...
    String sqlDisplayDateHoliday = "SELECT lm.Master_Ref_code, ld.`Master_Ref_code`, ld.Detail_Ref_code, pmsh.*, ld.Description "
            + "FROM lookup_master lm, lookup_detail ld, pms_holiday pmsh "
            + "WHERE lm.`Master_Ref_code` = ld.`Master_Ref_code` AND ld.`Master_Ref_code` = '0002' AND ld.`Detail_Ref_code` = pmsh.state_code AND pmsh.state_code = '04'  "
            + "ORDER BY pmsh.holiday_date ASC, ld.`Description` ASC";
    ArrayList<ArrayList<String>> dataDateHoliday = Conn.getData(sqlDisplayDateHoliday);
...
//                                    out.print(isSelect);
                ...
                <!--                                <div class="col-md-2 col-md-offset-3 col-sm-12 col-xs-12" style="background-color: yellowgreen">
                                    <form method="post" name="myform" role="form" action="adminAppointment.jsp">
                                        <button class="btn btn-info">Today's Availability</button>
                                    </form>
                                </div>-->
