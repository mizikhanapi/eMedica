<%-- 
    Document   : medicalStaffDoctorAppointmentViewDateAvailability
    Created on : Jul 31, 2016, 12:59:29 PM
    Author     : user
--%>
...
//out.print(hfc);
    ...
    String sql = "SELECT lm.Master_Ref_code, ld.`Master_Ref_code`, ld.Detail_Ref_code, pmsh.*, ld.Description "
            ...
            + "AND ld.`Detail_Ref_code` = pmsh.state_code "
...
<!--                                            <div class="form-group">
        ...
        <!--</div>-->
                ...
                <p>Date :  <%out.print(searchDateAvailability);%></p>
            <div class="table-responsive">
                <table class="table table-bordered table-hover">
                    <thead>
                        <tr>
...
//                                    String endLeave = DATE_FORMAT.format(endLeaveDate);
                                    ...
                                    <%
                                        ...
                                        {%>
                                            ...
                                            <td>
                                                <center>
                                                    <button disabled="disabled" class="btn btn-xs btn-primary" onClick="location.href='medicalStaffDoctorCancelAppointment.jsp?e27=<%=dataAppointment.get(i).get(2)%>&e48=<%=hfcCD%>&e32=<%=dataAppointment.get(i).get(0)%>'">Cancel</button>
                                                </center>
                                            </td>
