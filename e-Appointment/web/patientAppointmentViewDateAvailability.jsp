<%-- 
    Document   : patientAppointmentViewDateAvailability
    Created on : Jul 28, 2016, 9:02:26 AM
    Author     : user
--%>
...
//    out.print(searchDoctorAvailability);
                            ...
                            <form class="form-horizontal" role="form" method="post" action="patientCheckAppointment.jsp">
                                ...
                                <div class="row">
                                    <div class="col-md-8 col-md-offset-2 col-sm-12 col-xs-12">
                                        <!--<button class="btn btn-xs btn-success" type="submit" style="margin-bottom: 6%">Save</button>-->
