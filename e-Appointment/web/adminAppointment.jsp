...
//                                                   
//                                                   var arr=$("#state_ > option").map(function(){return $(this).val();});
//                                                   alert(arr.toString());
                                                   // alert(data);
//                                                    $("#state_ option").each(function(){
//                                                   
//                                                        alert($(this).text());
////                                                   if($(this).text == data){
////                                                       alert(data);
                                                            ...
                                                            <div class="col-md-3 col-sm-12 col-xs-12">
                                                                <form method="post" name="myform" role="form" action="adminAppointmentViewDateAvailability.jsp">
                                                                    <div class="form-inline" >
                                                                        <div class="form-group">
                                                                            <input type="date" name="searchDateAvailability"  class="form-control" placeholder="Search Appointment Date"/>
                                                                        </div>
                                                                        <div class="form-group">
