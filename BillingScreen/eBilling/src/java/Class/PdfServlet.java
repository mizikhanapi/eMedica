    ...
    protected void service(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (action.equalsIgnoreCase("yearlyStatement")){
                ...
                generateDetailsStatement(response);
            } else {
     ...
     private void generateYearlyStatement(HttpServletResponse response) {
...
//                        es.sendEmail();
     ...
     private void generateDetailsStatement(HttpServletResponse response){
