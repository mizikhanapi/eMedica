...
<%
    ...
    String orderList = "select ORDER_NO,DRUG_ITEM_CODE,DRUG_ITEM_DESC,DRUG_FREQUENCY,DRUG_ROUTE,DRUG_FORM,DRUG_STRENGTH,"
            ...
            + "where ORDER_NO = '" + orderNo + "' and DRUG_ITEM_CODE = '" + orderProductCode + "' AND pis_order_detail.STATUS = '0' AND pis_order_detail.QTY_ORDERED != pis_order_detail.QTY_DISPENSED";
...
<tbody>
    ...
    %>
    <tr id="updateDispenseDetailsTButton" data-status="pagado" data-toggle="modal" data-id="1" data-target="#updateDispenceOrder">
...
<td ><%=dataOrderDispenseList.get(i).get(6)%></td>
<td ><%=dataOrderDispenseList.get(i).get(3)%></td>
<td ><%=dataOrderDispenseList.get(i).get(9)%></td>
<td ><%=dataOrderDispenseList.get(i).get(17)%></td>
<td ><%=dataOrderDispenseList.get(i).get(7)%></td>
<td ><%=dataOrderDispenseList.get(i).get(11)%></td>
<td ><%=dataOrderDispenseList.get(i).get(18)%></td>
<td ><%=dataOrderDispenseList.get(i).get(14)%></td>
<td ><%=dataOrderDispenseList.get(i).get(19)%></td>
<td ><%= formatter.format(Double.parseDouble(dataOrderDispenseList.get(i).get(11)) * Double.parseDouble(dataOrderDispenseList.get(i).get(19)))%></td>
<td ><%=dataOrderDispenseList.get(i).get(16)%></td>
</tr>
<%  }
%>
</tbody>
