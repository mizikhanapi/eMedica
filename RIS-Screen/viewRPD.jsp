...
<table id="MD"  class="table table-striped table-bordered" cellspacing="0" width="100%">
    <%
        String query1 = "select modality_cd,ris_procedure_cd,ris_procedure_name,selling_price,status";
        ArrayList<ArrayList<String>> q1 = connect.getData(query1);
    %>
    <thead>
        <tr>
            <th class="col-sm-1">Modality Code</th>
            <th class="col-sm-1">RIS Procedure Code</th>
            <th class="col-sm-1">RIS Procedure Name</th>
            <th class="col-sm-1">Selling Price</th>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    <label>RIS Procedure Name</label>
                    ...
                    $(document).ready(function () {
                        $("#btn_update_<%=i%>").click(function () {
                           // var ccode = $("#ccode_<%=i%>").val();
                            ...
                            var ris_procedure_cd = $("#ris_procedure_cd_<%=i%>").val();
                            var ris_procedure_name = $("#ris_procedure_name_<%=i%>").val();
