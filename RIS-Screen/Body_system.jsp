<%-- 
    Document   : Body_system
    Created on : Feb 19, 2017, 4:23:41 PM
    Author     : Huda Athirah
--%>
				...
				<div class="col-md-12">
					...
					<form class="form-horizontal">
						...
						<div class="form-group">
						  <label class="col-md-4 control-label" for="selectbasic">Modality</label>
						  <div class="col-md-4">
							<select id="selectbasic" name="selectbasic" class="form-control">
							  <option value="1">Mobile x-ray</option>
					...
					<div class="text-center">
						<button id="button1id" name="button1id" class="btn btn-default"><i class="fa fa-plus fa-lg"></i>&nbsp; Add</button>
            ...
            <script>
                                $(document).ready(function () {
                                   ...
                                   $("#btn_add").click(function () {
                                       ...
                                       var body_system_cd = $("#body_system_cd").val();
                                       var body_system_name = $("#body_system_name").val();
