<%-- 
    Document   : viewBSD
    Created on : Feb 19, 2017, 5:36:57 PM
    Author     : Huda Athirah
--%>
...
<table id="MD"  class="table table-striped table-bordered" cellspacing="0" width="100%">
    <%
        String query1 = "select modality_name,body_system_cd,body_system_name,status";
        ArrayList<ArrayList<String>> q1 = connect.getData(query1);
    %>
    <thead>
        <tr>
            <th class="col-sm-1">Modality Name</th>
            <th class="col-sm-1">Body System Code</th>
            <th class="col-sm-1">Body System Name</th>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" id="modality_name_<%=i%>" value="<%=q1.get(i).get(1)%>" readonly="">
                                </div>
                                <div class="form-group">
                                    <label>Body System Code</label>
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="button" class="btn btn-primary" id="btn_update_<%=i%>">Update</button>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <script type="text/javascript" charset="utf-8">
                    $(document).ready(function () {
                        $("#btn_update_<%=i%>").click(function () {
                            ...
                            var body_system_cd = $("#body_system_cd_<%=i%>").val();
                            var body_system_name = $("#body_system_name_<%=i%>").val();
