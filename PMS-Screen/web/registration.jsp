				...
				<div class="form-group">
				  ...
				  <div class="col-md-4">
				    <select id="idType" name="idType" class="form-control">
				      <option selected="" disabled=""> Please select ID type</option>
    ...
    function searchPatient(){
      var idType = $('#idType').find(":selected").val();
        ...
        $('#registerQueue').click(function(){
            ...
            var pmi,epiDate,name,newic,oldic,typeId,idNo,rnNo,patCatCode,visTyCode,emTy,eliCatCode,eliTyCode,disCode,subDiscode,consultRoom,comQueue,doctor,prioGruCode,polCase,commDis,natuDisasCode,docTy,guardInd,referNo,gruGuard,glExpDate,epiTime,stat,hfc;
                pmi= $('#pmino').val();
