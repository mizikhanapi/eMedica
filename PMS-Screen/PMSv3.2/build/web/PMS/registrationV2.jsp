...
<%
    ...
    String Commonqueue = "select * from pms_queue_list where queue_type='CM' and hfc_cd='"+hfc+"' group by queue_type";
    String Consultationqueue = "select * from pms_queue_list where queue_type='FY' and hfc_cd='"+hfc+"'";
    String Doctorqueue = "select * from pms_queue_list where queue_type='PN' and hfc_cd='"+hfc+"'";
